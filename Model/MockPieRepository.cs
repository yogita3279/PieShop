...
namespace PieShop.Model
{
    public class MockPieRepository : IpieRepository
    {
        ...
        {
            return AllPies.FirstOrDefault(p => p.PieId == pieId);// returns the first element of the sequence
        }
